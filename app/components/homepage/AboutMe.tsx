      ...
      <div className="text-column">
        ...
        <div>
          <p>
            ...
            At <strong>IKEA’s Geomagical Labs</strong>, I led the development
            and launch of cutting-edge mixed-reality design tools that reach
            millions of users worldwide—driving growth, accessibility, and
            ...
            <strong>Node.js, Supabase, and PostgreSQL</strong> to deliver
